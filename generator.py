data = [
    ...
    (
        "[Python Upper App CI/CD](./labs/python/upper-app/lab.md)", 
        "[View Solution](./labs/python/upper-app/solution.md)", 
...
markdown_table = "| ID  | Lab                                                | Solution                                      | Workflow Status                                                                                      |\n"
markdown_table += "|-----|----------------------------------------------------|------------------------------------------------|-------------------------------------------------------------------------------------------------------|\n"
...
for lab, solution, status in data:
    # If the row is empty, leave the ID field blank and don't increment ID
    if lab == "" and solution == "" and status == "":
        markdown_table += "|     |            |            |            |            |\n"  # Blank row with empty columns
    else:
        markdown_table += f"| {current_id}   | {lab:<50} | {solution:<48} | {status:<100} |\n"
